...
$query = new WP_Query( array( 'post_type' => 'portfolio', 'paged' => $paged, 'posts_per_page' => 255) );
						...
						<?php 
							if($counter==0) {
								...
								<div class="row">
									...
									<?php
									$categories = get_categories(array('hide_empty' => true, 'child_of' => 720));
									  foreach ($categories as $cat) {
									  echo '<li class="ribbon"><div class="filter" data-filter=".'.$cat->slug.'">'.$cat->cat_name.'</div></li>';
									}
									$categories = get_categories(array('hide_empty' => true, 'child_of' => 671));
									  foreach ($categories as $cat) {
									  echo '<li class="ribbon"><div class="filter" data-filter=".'.$cat->slug.'">'.$cat->cat_name.'</div></li>';
									}
									?>
